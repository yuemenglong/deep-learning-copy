...
class ExtractSubprocessor(Subprocessor):
    ...
    def on_result (self, host_dict, data, result):
        if self.type == 'landmarks-manual':
            ...
            self.ea.cur_outer = LandmarksProcessor.draw_rect_landmarks (image, view_rect, view_landmarks, self.image_size, self.face_type, landmarks_color=landmarks_color)
